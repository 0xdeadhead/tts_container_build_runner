...
RUN PIP_NO_BUILD_ISOLATION=1 python3 -m pip install --no-cache-dir numpy==2.0.2
RUN PIP_NO_BUILD_ISOLATION=1 python3 -m pip install --no-cache-dir -r requirements.txt
